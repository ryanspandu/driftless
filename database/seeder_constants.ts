export const BUILTIN_PERMISSIONS: { name: string; description: string }[] = [
  ...
  { name: 'analytics:read', description: 'View website analytics (traffic, audience, pages).' },
  { name: 'forms:read', description: 'View form submissions (the inbox).' },
  { name: 'forms:manage', description: 'Mark, spam, or delete form submissions.' },
  { name: 'redirects:manage', description: 'Create / edit / delete URL redirects (301/302).' },
