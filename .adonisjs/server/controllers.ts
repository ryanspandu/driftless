...
export const controllers = {
  admin: {
    ...
    FormsDefinitions: () => import('#controllers/admin/forms_definitions_controller'),
  ...
  PublicForms: () => import('#controllers/public_forms_controller'),
  PublicMenus: () => import('#controllers/public_menus_controller'),
