...
export interface Registry {
  ...
  'posts.unlock': {
    methods: ["POST"]
    pattern: '/posts/:slug/unlock'
    types: {
      body: {}
      paramsTuple: [ParamValue]
      params: { slug: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/public_controller').default['unlock']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/public_controller').default['unlock']>>>
    }
  }
  'public.category': {
    methods: ["GET","HEAD"]
  ...
  'public.tag': {
    ...
    types: {
      ...
      params: { slug: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/public_controller').default['tag']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/public_controller').default['tag']>>>
    }
  }
  'blog': {
    methods: ["GET","HEAD"]
    ...
    types: {
      ...
      params: {}
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/public_controller').default['blog']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/public_controller').default['blog']>>>
    }
  }
  'public.offline': {
    methods: ["GET","HEAD"]
  ...
  'template_kits.page': {
    methods: ["GET","HEAD"]
    pattern: '/admin/ui/template-kits'
    types: {
      body: {}
      paramsTuple: []
      params: {}
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/admin/template_kits_controller').default['page']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/admin/template_kits_controller').default['page']>>>
    }
  }
  'template_kits.list': {
    methods: ["GET","HEAD"]
    pattern: '/api/admin/template-kits'
    types: {
      body: {}
      paramsTuple: []
      params: {}
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/admin/template_kits_controller').default['list']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/admin/template_kits_controller').default['list']>>>
    }
  }
  'template_kits.import_one': {
    methods: ["POST"]
    pattern: '/api/admin/template-kits/import'
    types: {
      body: {}
      paramsTuple: []
      params: {}
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/admin/template_kits_controller').default['importOne']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/admin/template_kits_controller').default['importOne']>>>
    }
  }
  'template_kits.export_one': {
    methods: ["GET","HEAD"]
    pattern: '/api/admin/template-kits/:id/export'
    types: {
      body: {}
      paramsTuple: [ParamValue]
      params: { id: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/admin/template_kits_controller').default['exportOne']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/admin/template_kits_controller').default['exportOne']>>>
    }
  }
  'template_kits.set_active': {
    methods: ["PUT"]
    pattern: '/api/admin/template-kits/:id/active'
    types: {
      body: {}
      paramsTuple: [ParamValue]
      params: { id: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/admin/template_kits_controller').default['setActive']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/admin/template_kits_controller').default['setActive']>>>
    }
  }
  ...
  'content_category.page': {
    methods: ["GET","HEAD"]
    pattern: '/admin/content/categories'
    types: {
      body: {}
      paramsTuple: []
      params: {}
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/admin/content_category_controller').default['page']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/admin/content_category_controller').default['page']>>>
    }
  }
  'content_tag.page': {
    methods: ["GET","HEAD"]
    pattern: '/admin/content/tags'
    types: {
      body: {}
      paramsTuple: []
      params: {}
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/admin/content_tag_controller').default['page']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/admin/content_tag_controller').default['page']>>>
    }
  }
  'content.edit_page': {
    methods: ["GET","HEAD"]
  ...
  'content_category.index': {
    methods: ["GET","HEAD"]
    pattern: '/api/admin/content-categories'
    types: {
      body: {}
      paramsTuple: []
      params: {}
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/admin/content_category_controller').default['index']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/admin/content_category_controller').default['index']>>>
    }
  }
  'content_category.store': {
    ...
    types: {
      ...
      params: {}
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/admin/content_category_controller').default['store']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/admin/content_category_controller').default['store']>>>
    }
  }
  'content_category.update': {
    methods: ["PUT"]
    pattern: '/api/admin/content-categories/:id'
    types: {
      body: {}
      paramsTuple: [ParamValue]
      params: { id: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/admin/content_category_controller').default['update']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/admin/content_category_controller').default['update']>>>
    }
  }
  'content_category.destroy': {
    ...
    types: {
      ...
      params: { id: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/admin/content_category_controller').default['destroy']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/admin/content_category_controller').default['destroy']>>>
    }
  }
  'content_tag.index': {
    methods: ["GET","HEAD"]
    pattern: '/api/admin/content-tags'
    types: {
      body: {}
      paramsTuple: []
      params: {}
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/admin/content_tag_controller').default['index']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/admin/content_tag_controller').default['index']>>>
    }
  }
  'content_tag.store': {
    methods: ["POST"]
    ...
    types: {
      ...
      params: {}
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/admin/content_tag_controller').default['store']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/admin/content_tag_controller').default['store']>>>
    }
  }
  'content_tag.update': {
    methods: ["PUT"]
    pattern: '/api/admin/content-tags/:id'
    types: {
      body: {}
      paramsTuple: [ParamValue]
      params: { id: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/admin/content_tag_controller').default['update']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/admin/content_tag_controller').default['update']>>>
    }
  }
  'content_tag.destroy': {
    methods: ["DELETE"]
    ...
    types: {
      ...
      params: { id: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/admin/content_tag_controller').default['destroy']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/admin/content_tag_controller').default['destroy']>>>
    }
  }
  'content.index': {
    methods: ["GET","HEAD"]
  ...
  'content.reveal_password': {
    methods: ["GET","HEAD"]
    pattern: '/api/admin/content/:id/password'
    types: {
      body: {}
      paramsTuple: [ParamValue]
      params: { id: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/admin/content_controller').default['revealPassword']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/admin/content_controller').default['revealPassword']>>>
    }
  }
  'content.store': {
    methods: ["POST"]
  ...
  'templates.import_one': {
    methods: ["POST"]
    pattern: '/api/admin/templates/import'
    types: {
      body: {}
      paramsTuple: []
      params: {}
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/admin/templates_controller').default['importOne']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/admin/templates_controller').default['importOne']>>>
    }
  }
  'templates.trash': {
    methods: ["GET","HEAD"]
    pattern: '/api/admin/templates/trash'
    types: {
      body: {}
      paramsTuple: []
      params: {}
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/admin/templates_controller').default['trash']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/admin/templates_controller').default['trash']>>>
    }
  }
  'templates.restore': {
    methods: ["POST"]
    pattern: '/api/admin/templates/:id/restore'
    types: {
      body: {}
      paramsTuple: [ParamValue]
      params: { id: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/admin/templates_controller').default['restore']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/admin/templates_controller').default['restore']>>>
    }
  }
  'templates.force_destroy': {
    methods: ["DELETE"]
    pattern: '/api/admin/templates/:id/force'
    types: {
      body: {}
      paramsTuple: [ParamValue]
      params: { id: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/admin/templates_controller').default['forceDestroy']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/admin/templates_controller').default['forceDestroy']>>>
    }
  }
  'templates.export_one': {
    methods: ["GET","HEAD"]
    pattern: '/api/admin/templates/:id/export'
    types: {
      body: {}
      paramsTuple: [ParamValue]
      params: { id: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/admin/templates_controller').default['exportOne']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/admin/templates_controller').default['exportOne']>>>
    }
  }
  'templates.duplicate': {
    methods: ["POST"]
  ...
  'menus.trash': {
    methods: ["GET","HEAD"]
    pattern: '/api/admin/menus/trash'
    types: {
      body: {}
      paramsTuple: []
      params: {}
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/admin/menus_controller').default['trash']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/admin/menus_controller').default['trash']>>>
    }
  }
  'menus.restore': {
    methods: ["POST"]
    pattern: '/api/admin/menus/:id/restore'
    types: {
      body: {}
      paramsTuple: [ParamValue]
      params: { id: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/admin/menus_controller').default['restore']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/admin/menus_controller').default['restore']>>>
    }
  }
  'menus.force_destroy': {
    methods: ["DELETE"]
    pattern: '/api/admin/menus/:id/force'
    types: {
      body: {}
      paramsTuple: [ParamValue]
      params: { id: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/admin/menus_controller').default['forceDestroy']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/admin/menus_controller').default['forceDestroy']>>>
    }
  }
  'menus.show': {
    methods: ["GET","HEAD"]
  ...
  'media.import_one': {
    methods: ["POST"]
    pattern: '/api/admin/media/import'
    types: {
      body: {}
      paramsTuple: []
      params: {}
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/admin/media_controller').default['importOne']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/admin/media_controller').default['importOne']>>>
    }
  }
  'media.store': {
    methods: ["POST"]
  ...
  'media.export_one': {
    methods: ["GET","HEAD"]
    pattern: '/api/admin/media/:id/export'
    types: {
      body: {}
      paramsTuple: [ParamValue]
      params: { id: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/admin/media_controller').default['exportOne']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/admin/media_controller').default['exportOne']>>>
    }
  }
  'media.replace': {
    methods: ["POST"]
  ...
  'data_transfer.job': {
    methods: ["GET","HEAD"]
    pattern: '/api/admin/data-transfer/jobs/:id'
    types: {
      body: {}
      paramsTuple: [ParamValue]
      params: { id: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/admin/data_transfer_controller').default['job']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/admin/data_transfer_controller').default['job']>>>
    }
  }
  'data_transfer.latest_job': {
    methods: ["GET","HEAD"]
    pattern: '/api/admin/data-transfer/latest/:kind'
    types: {
      body: {}
      paramsTuple: [ParamValue]
      params: { kind: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/admin/data_transfer_controller').default['latestJob']>>>
  ...
  'data_transfer.download_export': {
    ...
    types: {
      ...
      params: { id: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/admin/data_transfer_controller').default['downloadExport']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/admin/data_transfer_controller').default['downloadExport']>>>
    }
  }
  ...
  'shop.config': {
    methods: ["GET","HEAD"]
    pattern: '/api/shop/config'
    types: {
      body: {}
      paramsTuple: []
      params: {}
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#modules/ecommerce/controllers/storefront/catalog_controller').default['config']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#modules/ecommerce/controllers/storefront/catalog_controller').default['config']>>>
    }
  }
  'shop.products.index': {
    methods: ["GET","HEAD"]
  ...
  'shop.category': {
    ...
    types: {
      ...
      params: { slug: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#modules/ecommerce/controllers/storefront/pages_controller').default['category']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#modules/ecommerce/controllers/storefront/pages_controller').default['category']>>>
    }
  }
  'shop.tag': {
    methods: ["GET","HEAD"]
    pattern: '/shop/tag/:slug'
    types: {
      body: {}
      paramsTuple: [ParamValue]
      params: { slug: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#modules/ecommerce/controllers/storefront/pages_controller').default['tag']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#modules/ecommerce/controllers/storefront/pages_controller').default['tag']>>>
    }
  }
  'shop.download': {
    methods: ["GET","HEAD"]
  ...
  'ecommerce.products.tags': {
    methods: ["GET","HEAD"]
    pattern: '/admin/ecommerce/products/tags'
    types: {
      body: {}
      paramsTuple: []
      params: {}
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#modules/ecommerce/controllers/admin/products_controller').default['tagsPage']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#modules/ecommerce/controllers/admin/products_controller').default['tagsPage']>>>
    }
  }
  ...
  'ecommerce.api.tags.store': {
    ...
    pattern: '/api/admin/ecommerce/tags'
    types: {
      body: ExtractBody<InferInput<(typeof import('#modules/ecommerce/validators/catalog').createTagValidator)>>
      paramsTuple: []
      params: {}
      query: ExtractQuery<InferInput<(typeof import('#modules/ecommerce/validators/catalog').createTagValidator)>>
      response: ExtractResponse<Awaited<ReturnType<import('#modules/ecommerce/controllers/admin/tags_controller').default['store']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#modules/ecommerce/controllers/admin/tags_controller').default['store']>>> | { status: 422; response: { errors: SimpleError[] } }
    }
  }
  'ecommerce.api.tags.update': {
    methods: ["PUT"]
    pattern: '/api/admin/ecommerce/tags/:id'
    types: {
      body: ExtractBody<InferInput<(typeof import('#modules/ecommerce/validators/catalog').updateTagValidator)>>
      paramsTuple: [ParamValue]
      params: { id: ParamValue }
      query: ExtractQuery<InferInput<(typeof import('#modules/ecommerce/validators/catalog').updateTagValidator)>>
      response: ExtractResponse<Awaited<ReturnType<import('#modules/ecommerce/controllers/admin/tags_controller').default['update']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#modules/ecommerce/controllers/admin/tags_controller').default['update']>>> | { status: 422; response: { errors: SimpleError[] } }
    }
  }
  'ecommerce.api.tags.destroy': {
    methods: ["DELETE"]
    pattern: '/api/admin/ecommerce/tags/:id'
    types: {
      body: {}
  ...
  'ecommerce.api.data.export': {
    methods: ["POST"]
    pattern: '/api/admin/ecommerce/data/export'
    types: {
      body: {}
      paramsTuple: []
      params: {}
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#modules/ecommerce/controllers/admin/settings_controller').default['exportData']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#modules/ecommerce/controllers/admin/settings_controller').default['exportData']>>>
    }
  }
  'ecommerce.api.data.import': {
    methods: ["POST"]
    pattern: '/api/admin/ecommerce/data/import'
    types: {
      body: {}
      paramsTuple: []
      params: {}
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#modules/ecommerce/controllers/admin/settings_controller').default['importData']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#modules/ecommerce/controllers/admin/settings_controller').default['importData']>>>
    }
  }
  ...
  'mcp.pages.insertSection': {
    methods: ["POST"]
    pattern: '/api/mcp/v1/pages/:id/insert-section'
    types: {
      body: {}
      paramsTuple: [ParamValue]
      params: { id: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/pages_controller').default['insertSection']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/pages_controller').default['insertSection']>>>
    }
  }
  'mcp.pages.render': {
    methods: ["GET","HEAD"]
  ...
  'mcp.pages.screenshot': {
    methods: ["GET","HEAD"]
    pattern: '/api/mcp/v1/pages/:id/screenshot'
    types: {
      body: {}
      paramsTuple: [ParamValue]
      params: { id: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/pages_controller').default['screenshot']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/pages_controller').default['screenshot']>>>
    }
  }
  'mcp.pages.compare': {
    methods: ["GET","HEAD"]
    pattern: '/api/mcp/v1/pages/:id/compare'
    types: {
      body: {}
      paramsTuple: [ParamValue]
      params: { id: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/pages_controller').default['compare']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/pages_controller').default['compare']>>>
    }
  }
  'mcp.pages.publish': {
    methods: ["POST"]
  ...
  'mcp.pages.analyzeLayout': {
    methods: ["POST"]
    pattern: '/api/mcp/v1/pages/:id/analyze-layout'
    types: {
      body: {}
      paramsTuple: [ParamValue]
      params: { id: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/pages_controller').default['analyzeLayout']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/pages_controller').default['analyzeLayout']>>>
    }
  }
  'mcp.pages.lintLayout': {
    methods: ["GET","HEAD"]
    pattern: '/api/mcp/v1/pages/:id/lint-layout'
    types: {
      body: {}
      paramsTuple: [ParamValue]
      params: { id: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/pages_controller').default['lintLayout']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/pages_controller').default['lintLayout']>>>
    }
  }
  'mcp.pages.discard': {
    methods: ["POST"]
  ...
  'mcp.content.categories.index': {
    methods: ["GET","HEAD"]
    pattern: '/api/mcp/v1/content-categories'
    types: {
      body: {}
      paramsTuple: []
      params: {}
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/content_controller').default['indexCategories']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/content_controller').default['indexCategories']>>>
    }
  }
  'mcp.content.categories.store': {
    methods: ["POST"]
    pattern: '/api/mcp/v1/content-categories'
    types: {
      body: {}
      ...
      params: {}
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/content_controller').default['storeCategory']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/content_controller').default['storeCategory']>>>
    }
  }
  'mcp.content.categories.update': {
    methods: ["PUT"]
    pattern: '/api/mcp/v1/content-categories/:id'
    types: {
      body: {}
      paramsTuple: [ParamValue]
      params: { id: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/content_controller').default['updateCategory']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/content_controller').default['updateCategory']>>>
    }
  }
  'mcp.content.categories.destroy': {
    methods: ["DELETE"]
    pattern: '/api/mcp/v1/content-categories/:id'
    types: {
      body: {}
      ...
      params: { id: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/content_controller').default['destroyCategory']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/content_controller').default['destroyCategory']>>>
    }
  }
  'mcp.content.tags.index': {
    methods: ["GET","HEAD"]
    pattern: '/api/mcp/v1/content-tags'
    types: {
      body: {}
      paramsTuple: []
      params: {}
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/content_controller').default['indexTags']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/content_controller').default['indexTags']>>>
    }
  }
  'mcp.content.tags.store': {
    methods: ["POST"]
    pattern: '/api/mcp/v1/content-tags'
    types: {
      body: {}
      ...
      params: {}
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/content_controller').default['storeTag']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/content_controller').default['storeTag']>>>
    }
  }
  'mcp.content.tags.update': {
    methods: ["PUT"]
    pattern: '/api/mcp/v1/content-tags/:id'
    types: {
      body: {}
      paramsTuple: [ParamValue]
      params: { id: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/content_controller').default['updateTag']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/content_controller').default['updateTag']>>>
    }
  }
  'mcp.content.tags.destroy': {
    methods: ["DELETE"]
    pattern: '/api/mcp/v1/content-tags/:id'
    types: {
      body: {}
      ...
      params: { id: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/content_controller').default['destroyTag']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/content_controller').default['destroyTag']>>>
    }
  }
  'mcp.content.index': {
    methods: ["GET","HEAD"]
    pattern: '/api/mcp/v1/content'
    types: {
      body: {}
      paramsTuple: []
      params: {}
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/content_controller').default['index']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/content_controller').default['index']>>>
    }
  }
  'mcp.content.show': {
    methods: ["GET","HEAD"]
    pattern: '/api/mcp/v1/content/:id'
    types: {
      body: {}
      paramsTuple: [ParamValue]
      params: { id: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/content_controller').default['show']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/content_controller').default['show']>>>
    }
  }
  'mcp.content.store': {
    methods: ["POST"]
    ...
    types: {
      ...
      params: {}
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/content_controller').default['store']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/content_controller').default['store']>>>
    }
  }
  'mcp.content.update': {
    methods: ["PUT"]
    ...
    types: {
      ...
      params: { id: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/content_controller').default['update']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/content_controller').default['update']>>>
    }
  }
  'mcp.content.destroy': {
    methods: ["DELETE"]
    ...
    types: {
      ...
      params: { id: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/content_controller').default['destroy']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/content_controller').default['destroy']>>>
    }
  }
  'mcp.templates.index': {
    methods: ["GET","HEAD"]
  ...
  'mcp.templates.sectionPresets': {
    methods: ["GET","HEAD"]
    pattern: '/api/mcp/v1/section-presets'
    types: {
      body: {}
      paramsTuple: []
      params: {}
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/templates_controller').default['sectionPresets']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/templates_controller').default['sectionPresets']>>>
    }
  }
  'mcp.templates.show': {
    methods: ["GET","HEAD"]
  ...
  'mcp.forms.index': {
    methods: ["GET","HEAD"]
    pattern: '/api/mcp/v1/forms'
    types: {
      body: {}
      paramsTuple: []
      params: {}
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/forms_controller').default['index']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/forms_controller').default['index']>>>
    }
  }
  'mcp.forms.show': {
    methods: ["GET","HEAD"]
    pattern: '/api/mcp/v1/forms/:id'
    types: {
      body: {}
      paramsTuple: [ParamValue]
      params: { id: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/forms_controller').default['show']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/forms_controller').default['show']>>>
    }
  }
  'mcp.forms.store': {
    methods: ["POST"]
    ...
    types: {
      ...
      params: {}
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/forms_controller').default['store']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/forms_controller').default['store']>>>
    }
  }
  'mcp.forms.update': {
    methods: ["PUT"]
    ...
    types: {
      ...
      params: { id: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/forms_controller').default['update']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/forms_controller').default['update']>>>
    }
  }
  'mcp.forms.destroy': {
    methods: ["DELETE"]
    ...
    types: {
      ...
      params: { id: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/forms_controller').default['destroy']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/forms_controller').default['destroy']>>>
    }
  }
  'mcp.appearance.get': {
    methods: ["GET","HEAD"]
  ...
  'mcp.pageroles': {
    methods: ["PUT"]
    pattern: '/api/mcp/v1/page-roles'
    types: {
      body: {}
      paramsTuple: []
      params: {}
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/settings_controller').default['usePageAsRole']>>>
  ...
  'mcp.media.palette': {
    methods: ["GET","HEAD"]
    pattern: '/api/mcp/v1/media/:id/palette'
    types: {
      body: {}
      paramsTuple: [ParamValue]
      params: { id: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/media_controller').default['palette']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/media_controller').default['palette']>>>
    }
  }
  'mcp.media.store': {
    methods: ["POST"]
  ...
  'mcp.products.tags.index': {
    methods: ["GET","HEAD"]
    pattern: '/api/mcp/v1/product-tags'
    types: {
      body: {}
      paramsTuple: []
      params: {}
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/products_controller').default['indexTags']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/products_controller').default['indexTags']>>>
    }
  }
  'mcp.products.show': {
    methods: ["GET","HEAD"]
  ...
  'mcp.products.tags.store': {
    ...
    types: {
      ...
      params: {}
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/products_controller').default['storeTag']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/products_controller').default['storeTag']>>>
    }
  }
  'mcp.products.tags.update': {
    methods: ["PUT"]
    pattern: '/api/mcp/v1/product-tags/:id'
    types: {
      body: {}
      paramsTuple: [ParamValue]
      params: { id: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/products_controller').default['updateTag']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/products_controller').default['updateTag']>>>
    }
  }
  'mcp.products.tags.destroy': {
    methods: ["DELETE"]
    pattern: '/api/mcp/v1/product-tags/:id'
    types: {
      body: {}
      ...
      params: { id: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/products_controller').default['destroyTag']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/products_controller').default['destroyTag']>>>
    }
  }
  'mcp.ecommerce.storefront.pages': {
    methods: ["PUT"]
    pattern: '/api/mcp/v1/storefront-pages'
    types: {
      body: {}
      paramsTuple: []
      params: {}
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/ecommerce_settings_controller').default['setStorefrontPage']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#modules/mcp/controllers/api/ecommerce_settings_controller').default['setStorefrontPage']>>>
    }
  }
  'ctrl.page': {
    methods: ["GET","HEAD"]
