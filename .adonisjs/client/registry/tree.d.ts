...
export interface ApiDefinition {
  ...
  public: {
    ...
    category: typeof routes['public.category']
    tag: typeof routes['public.tag']
    offline: typeof routes['public.offline']
  }
  posts: {
    unlock: typeof routes['posts.unlock']
  }
  ...
  media: {
    ...
    importOne: typeof routes['media.import_one']
    store: typeof routes['media.store']
    show: typeof routes['media.show']
    exportOne: typeof routes['media.export_one']
  ...
  templateKits: {
    page: typeof routes['template_kits.page']
    list: typeof routes['template_kits.list']
    importOne: typeof routes['template_kits.import_one']
    exportOne: typeof routes['template_kits.export_one']
    setActive: typeof routes['template_kits.set_active']
  }
  users: {
  ...
  content: {
    ...
    revealPassword: typeof routes['content.reveal_password']
  ...
  contentCategory: {
    page: typeof routes['content_category.page']
    index: typeof routes['content_category.index']
    store: typeof routes['content_category.store']
    update: typeof routes['content_category.update']
    destroy: typeof routes['content_category.destroy']
  }
  contentTag: {
    page: typeof routes['content_tag.page']
    index: typeof routes['content_tag.index']
    store: typeof routes['content_tag.store']
    update: typeof routes['content_tag.update']
    destroy: typeof routes['content_tag.destroy']
  }
  pages: {
  ...
  templates: {
    ...
    importOne: typeof routes['templates.import_one']
    trash: typeof routes['templates.trash']
    restore: typeof routes['templates.restore']
    forceDestroy: typeof routes['templates.force_destroy']
    exportOne: typeof routes['templates.export_one']
  ...
  menus: {
    ...
    trash: typeof routes['menus.trash']
    restore: typeof routes['menus.restore']
    forceDestroy: typeof routes['menus.force_destroy']
  ...
  ecommerce: {
    ...
    products: {
      ...
      tags: typeof routes['ecommerce.products.tags']
    ...
    api: {
      ...
      data: {
        export: typeof routes['ecommerce.api.data.export']
        import: typeof routes['ecommerce.api.data.import']
      }
      discounts: {
  ...
  shop: {
    config: typeof routes['shop.config']
    products: {
  ...
  mcp: {
    ...
    pages: {
      ...
      insertSection: typeof routes['mcp.pages.insertSection']
      render: typeof routes['mcp.pages.render']
      screenshot: typeof routes['mcp.pages.screenshot']
      compare: typeof routes['mcp.pages.compare']
      ...
      analyzeLayout: typeof routes['mcp.pages.analyzeLayout']
      lintLayout: typeof routes['mcp.pages.lintLayout']
      discard: typeof routes['mcp.pages.discard']
      destroy: typeof routes['mcp.pages.destroy']
    }
    content: {
      categories: {
        index: typeof routes['mcp.content.categories.index']
        store: typeof routes['mcp.content.categories.store']
        update: typeof routes['mcp.content.categories.update']
        destroy: typeof routes['mcp.content.categories.destroy']
      }
      tags: {
        index: typeof routes['mcp.content.tags.index']
        store: typeof routes['mcp.content.tags.store']
        update: typeof routes['mcp.content.tags.update']
        destroy: typeof routes['mcp.content.tags.destroy']
      }
      index: typeof routes['mcp.content.index']
      show: typeof routes['mcp.content.show']
      store: typeof routes['mcp.content.store']
      update: typeof routes['mcp.content.update']
      destroy: typeof routes['mcp.content.destroy']
    }
    templates: {
      index: typeof routes['mcp.templates.index']
      sectionPresets: typeof routes['mcp.templates.sectionPresets']
    ...
    forms: {
      index: typeof routes['mcp.forms.index']
      show: typeof routes['mcp.forms.show']
      store: typeof routes['mcp.forms.store']
      update: typeof routes['mcp.forms.update']
      destroy: typeof routes['mcp.forms.destroy']
    }
    ...
    products: {
      ...
      tags: {
        index: typeof routes['mcp.products.tags.index']
        store: typeof routes['mcp.products.tags.store']
        update: typeof routes['mcp.products.tags.update']
        destroy: typeof routes['mcp.products.tags.destroy']
      }
    ...
    ecommerce: {
      storefront: {
        pages: typeof routes['mcp.ecommerce.storefront.pages']
      }
    }
  }
  ctrl: {
