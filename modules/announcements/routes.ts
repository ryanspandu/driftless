...
const AdminController = () => import('#modules/announcements/controllers/announcements_controller')
const PublicController = () =>
  import('#modules/announcements/controllers/announcements_public_controller')
...
export function registerRoutes(router: HttpRouterService, middleware: NamedMiddleware) {
  ...
  router
    ...
    .use(middleware.auth())
    .use(middleware.moduleEnabled({ name: 'announcements' }))
