...
function Button({
  ...
  // When we delegate rendering to a non-button element (e.g. `<Link />` which
  // becomes an `<a>`), Base UI's default `nativeButton: true` triggers a
  // runtime warning. Default it to `false` in that case so callers don't have
